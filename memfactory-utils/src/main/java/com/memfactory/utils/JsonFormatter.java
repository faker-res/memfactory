...
public class JsonFormatter {
	...
	public static <T> T toObject(String content, Class<?> collectionClass, Class<?>... elementClasses) throws JsonParseException, JsonMappingException, IOException {
	...
	public static <T> T toObject(String content, Class<T> type, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
		return get(serializeNull).readValue(content, type);
	}

	public static <T> T toObject(File src, Class<T> type, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
		return get(serializeNull).readValue(src, type);
	}

	public static <T> T toObject(InputStream in, Class<T> type, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
		return get(serializeNull).readValue(in, type);
	}

	public static <T> T toObject(Reader reader, Class<T> type, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
		return get(serializeNull).readValue(reader, type);
	}

	public static <T> T toObject(URL url, Class<T> type, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
		return get(serializeNull).readValue(url, type);
	}

	public static <T> T toObject(byte[] src, Class<T> type, boolean serializeNull) throws JsonParseException, JsonMappingException, IOException {
		return get(serializeNull).readValue(src, type);
	}
	...
	public static void toJsonToFile(File resultFile, Object value) throws JsonGenerationException, JsonMappingException, IOException {
		toJsonToFile(resultFile, value, true);
	}

	public static void toJsonToOutputSteam(OutputStream out, Object value) throws JsonGenerationException, JsonMappingException, IOException {
		toJsonToOutputSteam(out, value, true);
	}

	public static void toJsonToWriter(Writer writer, Object value) throws JsonGenerationException, JsonMappingException, IOException {
		toJsonToWriter(writer, value, true);
	}

	// 以下是带参数(是否允许为空)的序列化方法
	public static String toJsonAsString(Object value, boolean serializeNull) throws JsonGenerationException, JsonMappingException, IOException {
		return get(serializeNull).writeValueAsString(value);
	}

	public static byte[] toJsonAsByte(Object value, boolean serializeNull) throws JsonGenerationException, JsonMappingException, IOException {
		return get(serializeNull).writeValueAsBytes(value);
	}

	public static void toJsonToFile(File resultFile, Object value, boolean serializeNull) throws JsonGenerationException, JsonMappingException, IOException {
		get(serializeNull).writeValue(resultFile, value);
	}

	public static void toJsonToOutputSteam(OutputStream out, Object value, boolean serializeNull) throws JsonGenerationException, JsonMappingException, IOException {
		get(serializeNull).writeValue(out, value);
	}

	public static void toJsonToWriter(Writer writer, Object value, boolean serializeNull) throws JsonGenerationException, JsonMappingException, IOException {
